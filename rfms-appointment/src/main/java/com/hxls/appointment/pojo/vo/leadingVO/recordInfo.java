...
public class recordInfo {
     ...
     * 运输量
     */
    @ExcelProperty(value = "运输量" ,order = 9)
     ...
     * 物品名称
     */
    @ExcelProperty(value = "运输货物" , order = 8)
     ...
     * 车队名称
     */
    @ExcelProperty(value = "车队名称" , order = 11)
     ...
     * 发动机编号
     */
    @ExcelProperty(value = "发动机号" , order = 6)
    private String engineNumber;
    /**
     * 排放标准
     */
    @ExcelProperty(value = "排放等级" , order = 7)
    private String emissionStandard;

    /**
     * 行驶证路径
     */
    @ExcelProperty(value = "行驶证" , order = 12)
    private String drivingLicense;

    /**
     * 随车清单路径
     */
    @ExcelProperty(value = "车辆图片" , order = 13)
    private String followInventory;

    /**
     * 单位
     */
    @ExcelProperty(value = "单位" , order = 10)
    private String unit;

    /**
     * 组织名称
     */
    @ExcelProperty(value = "组织名称" , order = 14)
    private String orgName = "四川华西绿舍精城建材有限公司";
    /**
     * 组织编码
     */
    @ExcelProperty(value = "组织编码" , order = 15)
